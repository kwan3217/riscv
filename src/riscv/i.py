...
class I(InstructionSet):
    ...
    ins_exec={
        ...
        "+_|_____ 43210 lllll |_| ddddd __|__||":RegImmed("SRAI", ">A>", lambda hart, rs1, imm: hart.signed(rs1) >> imm),
        ...
        " _______ zzzzz lllll __| ddddd _||__||":RegReg("SLL", "<<", lambda hart, rs1, rs2: rs1 << read_bitfield(rs2, hart.xbits-1, 0)),
        ...
        " _______ zzzzz lllll |_| ddddd _||__||":RegReg("SRL", ">L>", lambda hart, rs1, rs2: rs1 >> read_bitfield(rs2, hart.xbits-1, 0)),
        " _|_____ zzzzz lllll |_| ddddd _||__||":RegReg("SRA", ">A>", lambda hart, rs1, rs2: hart.signed(rs1) >> read_bitfield(rs2, hart.xbits-1, 0)),

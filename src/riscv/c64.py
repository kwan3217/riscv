...
class C64(InstructionSet):
    ins_exec={
        ...
        "+|__ 5 __ ggg 43210 _|": I.RegImmed("C.SRLI", ">L>", lambda hart, rs1, imm: rs1 >> imm),  # Bit 12 is nzimm5, which must be 0 for RV32C
        "+|__ 5 _| ggg 43210 _|": I.RegImmed("C.SRAI", ">A>", lambda hart, rs1, imm: hart.signed(rs1) >> imm),  # Bit 12 is nzimm5, which must be 0 for RV32C
        ...
        "+___ 5 fffff 43210 |_": I.RegImmed("C.SLLI", "<<", lambda hart, rs1, imm: rs1 << imm),  # Bit 12 is nzimm5, which must be 0 for C32I
